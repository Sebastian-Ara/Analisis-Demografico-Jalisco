# Análisis Demográfico de Jalisco

## 📌 Descripción del proyecto
Este proyecto presenta un análisis exploratorio de datos demográficos del estado de Jalisco,
con el objetivo de identificar patrones poblacionales a partir de variables como edad, sexo
...
Este repositorio se conserva con fines demostrativos para mostrar:
- Estructura de un análisis de datos
- Uso de librerías de análisis en Python
...
- Tendencias demográficas generales
